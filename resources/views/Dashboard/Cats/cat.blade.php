          ...
          <div class="card my-4">
            ...
            <div class="card-body px-0 pb-2">
              <div class="table-responsive p-0">
                ...
                <a href="{{ route('cat-creat-us') }}"><button class="btn btn-danger btn-sm ">AddNew </button></a>
                      </th>
                    </tr>
                  </thead>
                  <tbody>
                    ...
                    @foreach ($cats as $c )
                      ...
                      <td class="align-middle  d-flex justify-content-end me-3">
                        <a href="{{ route('cat-edit-us',$c->id) }}"><button class="btn btn-info btn-sm me-2">Edit</button></a>
                <a href="{{ route('delete-us',$c->id) }}"><button class="btn btn-danger btn-sm ">Delete</button></a>
                      </td>
                    </tr>
                    @endforeach
                  </tbody>
