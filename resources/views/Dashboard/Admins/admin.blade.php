          ...
          <div class="card my-4">
            ...
            <div class="card-body px-0 pb-2">
              <div class="table-responsive p-0">
                ...
                <a href="{{ route('admin-create-us') }}"><button class="btn btn-danger btn-sm ">AddNew </button></a>
                      </th>
                    </tr>
                  </thead>
                  <tbody>
                ...
                <a href="{{ route('delete-admin-us',$c->id) }}"><button class="btn btn-danger btn-sm ">Delete</button></a>
                      </td>
                    </tr>
                    @endforeach
                  </tbody>
