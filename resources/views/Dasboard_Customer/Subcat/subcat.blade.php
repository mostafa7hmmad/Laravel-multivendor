                ...
                <table class="table align-items-center mb-0">
                  <thead>
                    <tr>
                      ...
                      <th class="text-center text-dark text-uppercase text-secondary text-xxs font-weight-bolder ">Price</th>
                 ...
                 <a href="{{ route('Dasboard-customer-us') }}"><button class="btn btn-info btn-sm me-2 ">Back</button></a>
                  ...
                  <tbody>
                    ...
                    @foreach ($subcat as $c )
                      ...
                      <td class="align-middle text-center">
                        <span class="text-secondary text-xs font-weight-bold"><img class="w-20" src="{{ asset('uploades/subcat/'.$c->img) }}" alt=""></span>
                      </td>
